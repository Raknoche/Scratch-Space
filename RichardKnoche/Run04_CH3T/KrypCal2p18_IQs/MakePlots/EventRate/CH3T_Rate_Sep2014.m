...
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\Run04_CH3T\KrypCal2p18_IQs\MakePlots\CH3T_Sep2014_Kr2p18.mat');
    %Take out ugly data for august 2014 data sets
     total_time_x([1,2,10,11,21,22,32,33,42,43,52,53,62,63])=[];
     total_hist_evt_time([1,2,10,11,21,22,32,33,42,43,52,53,62,63])=[];
     total_sigma_hist_evt_time([1,2,10,11,21,22,32,33,42,43,52,53,62,63])=[];
