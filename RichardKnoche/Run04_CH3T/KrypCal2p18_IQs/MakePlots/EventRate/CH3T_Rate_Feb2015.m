...
load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\Run04_CH3T\KrypCal2p18_IQs\MakePlots\CH3T_Feb2015_Kr2p18.mat');
    ...
    %Take out ugly data for august 2014 data sets
     total_time_x([1,2,14,15,16,28,29,30,43,44,45,47,48,50])=[];
     total_hist_evt_time([1,2,14,15,16,28,29,30,43,44,45,47,48,50])=[];
     total_sigma_hist_evt_time([1,2,14,15,16,28,29,30,43,44,45,47,48,50])=[];
