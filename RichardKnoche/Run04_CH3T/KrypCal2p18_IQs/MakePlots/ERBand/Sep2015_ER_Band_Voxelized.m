...
fiducial_cut=inrange(drift_time,[40 300]) & inrange(s2radius_del,[0,max_r]) & ...
    inrange(s2x_del,[x_max-x_step x_max]) & inrange(s2y_del,[y_max-y_step y_max]) & inrange(drift_time,[z_max-z_step z_max]);
...
%% Plot the ER bands
save('Sep2015_2p18_ERFit_Voxels','ER_lower_power_fit_vox','ER_upper_power_fit_vox','ER_mean_power_fit_vox');

load('C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\Run04_CH3T\KrypCal2p18_IQs\MakePlots\ERBand\ERBandFits\Sep2015_2p18_ERFit.mat');
