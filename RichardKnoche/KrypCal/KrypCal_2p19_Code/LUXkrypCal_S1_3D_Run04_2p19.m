function [lug_val] = LUXkrypCal_S1_3D_2p19(s1_phe_both,s1_phe_bottom,s2_phe_both,s2x,s2y,drift_time,x_center,y_center,z_center,det_edge,inpaint_on,user_name,file_id_cp,dp_version, algorithm_name, submit)
...
s1_phe_both_xyz=s1_phe_both.*interp3(s1xbins,s1ybins,s1zbins,norm_s1_both_xyz,s2x,s2y,drift_time,'spline',1);

s1_phe_both_xyz3D_gauss_fit=fit([0:10:1000].',hist(s1_phe_both_xyz(inrange(s1_phe_both_xyz,[0 1000])),[0:10:1000]).','gauss1');
