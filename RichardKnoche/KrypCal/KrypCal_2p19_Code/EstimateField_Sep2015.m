function [ FieldValues ] = EstimateField_Sep2015( s2radius, s2drift )
...
load('C:\Program Files\MATLAB\R2012a\bin\Run04_ERBand\Kr2p19\DirectMeasurement\sep2015_field_map.mat')

%% Reshape simulated field data
sim_radius=reshape(sep2015_field_map.r_end_cm,1,size(sep2015_field_map.r_end_cm,1)*size(sep2015_field_map.r_end_cm,2));
sim_drift=reshape(sep2015_field_map.t_end_us,1,size(sep2015_field_map.t_end_us,1)*size(sep2015_field_map.t_end_us,2));
sim_field=reshape(sep2015_field_map.E_start_Vcm,1,size(sep2015_field_map.E_start_Vcm,1)*size(sep2015_field_map.E_start_Vcm,2));
