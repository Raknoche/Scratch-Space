...
if length(folders_to_load)>13
    for   ii=1:13 % after 13 submitions Matlab will crash due to java memory leak
            ...
            if ( ismember({'ccv_rqs_done'},{files_available.name}) || use_ccv_flag==0 )
                ...
                LUXkrypCal_Run04_2p14(d,user_name,dp_version,algorithm_name,1); %rq,use pulse_class,submit IQ to LUG,delay time min     
                else
