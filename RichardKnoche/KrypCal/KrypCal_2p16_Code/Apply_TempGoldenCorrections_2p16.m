function [ s2_z, s2_xyz, s1_z, s1_xyz ] = Apply_TempGoldenCorrections_2p16(s2,s1,s2x,s2y,drift_time,file_name,LoadLocation)
...
%Apply like this:
%    IQ_location='C:\Program Files\MATLAB\R2012a\bin\LUXCode\Scratch\RichardKnoche\KrypCal\KrypCal_2p16_Code\IQ_Query_Results';
%     [ s2_phe_both_z, s2_phe_both_xyz, s1_phe_both_z, s1_phe_both_xyz ] = Apply_TempGoldenCorrections_2p16(s2_phe_both,s1_phe_both,s2x,s2y,drift_time,'lux10_20140903T1918_cp13848',IQ_location);
...
s2_z_correction=interp1(s2_norm_z,s2_norm, drift_time,'spline',1);
