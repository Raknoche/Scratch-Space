...
h3_area_cut=(inrange(s2_phe_both,[630 10000]) & inrange(s1_phe_both,[1 141]));
...
folders_to_load{1}='lux10_20150929T1905_cp17548';
...
rqs_to_load = {'pulse_area_phe','event_timestamp_samples'...
   ...
   ,'x_corrected','y_corrected','top_bottom_ratio','x_cm'...
...
Mean_s2_3D_both=zeros(length(s2xbins),length(s2ybins),length(s2zbins));
Mean_s2_3D_bottom=zeros(length(s2xbins),length(s2ybins),length(s2zbins));
Mean_s2_3D_both_err=zeros(length(s2xbins),length(s2ybins),length(s2zbins));
Mean_s2_3D_bottom_err=zeros(length(s2xbins),length(s2ybins),length(s2zbins));
Sigma_s2_3D_both=zeros(length(s2xbins),length(s2ybins),length(s2zbins));
Sigma_s2_3D_bottom=zeros(length(s2xbins),length(s2ybins),length(s2zbins));
...
save('C:\Program Files\MATLAB\R2012a\bin\Run04_ERBand\Kr2p18\DirectMeasurement\S1aS1bfieldmapping_2p18_2015polyfit','s1ab_xyz_mean_map','s1p_s1_3D_s1as1b_bins_map','s1ab_xyz_mean_err_map','s1p_s1_3D_s1as1b_bins_err_map',...
