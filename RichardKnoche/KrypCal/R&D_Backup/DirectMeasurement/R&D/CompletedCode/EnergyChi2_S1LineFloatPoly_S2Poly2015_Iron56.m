%NOTE: This had a bug,     b2_counter=a2_counter+1;    
%Any 4D map will be indexed incorrectly... but I dont really use those... so w/e
...
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p19/NEST_CH3T_Spectrum.mat')

a2_counter=1;
for a2=-0.4:0.02:0.4; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
    b2_counter=1;
    for b2=-1.5:0.1:1.5; %p1*x^2 coefficient for s1ab_s2_xyz_fit.p1
...
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p19/MappingParametersFit_Start_2015_CutDown.mat')
...
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p19/CH3T_Sep2015_NoCorrections.mat');
...
clear s1_phe_both s2_phe_both
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p19/MappingParametersFit_Start_2014_CutDown.mat')
...
clear s1_phe_both s2_phe_both
load('/scratch4/UMDcode/EnergyChi2/KrypCal_2p19/CH3T_Sep2014_NoCorrections.mat');
...
total_h3_chi2_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_h3_chi2;
total_kr_chi2_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_kr_chi2;
total_chi2_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_chi2;
alternate_total_chi2_map(a2_counter,b2_counter,g1_counter,g2_counter)=alternate_total_chi2;
h3_chi2_2014_map(a2_counter,b2_counter,g1_counter,g2_counter)=h3_chi2_2014;
kr_chi2_2014_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_kr_chi2_2014;
h3_chi2_2015_map(a2_counter,b2_counter,g1_counter,g2_counter)=h3_chi2_2015;
kr_chi2_2015_map(a2_counter,b2_counter,g1_counter,g2_counter)=total_kr_chi2_2015;
electron_lifetime_2014_map(a2_counter,b2_counter,g1_counter,g2_counter)=pseudo_lifetime_2014;
electron_lifetime_2015_map(a2_counter,b2_counter,g1_counter,g2_counter)=pseudo_lifetime_2015;
...
total_h3_chi2_map(a2_counter,b2_counter,:,:)=-1;
total_kr_chi2_map(a2_counter,b2_counter,:,:)=-1;
total_chi2_map(a2_counter,b2_counter,:,:)=-1;
alternate_total_chi2_map(a2_counter,b2_counter,:,:)=-1;
h3_chi2_2014_map(a2_counter,b2_counter,:,:)=-1;
kr_chi2_2014_map(a2_counter,b2_counter,:,:)=-1;
h3_chi2_2015_map(a2_counter,b2_counter,:,:)=-1;
kr_chi2_2015_map(a2_counter,b2_counter,:,:)=-1;
electron_lifetime_2014_map(a2_counter,b2_counter,:,:)=-1;
electron_lifetime_2015_map(a2_counter,b2_counter,:,:)=-1;
...
save('/scratch4/UMDcode/EnergyChi2/KrypCal_2p19/S1aS1bParamScan_EnergyChi2_S1FloatPoly_S2Poly2015.mat') 
