...
cp_number = {};
 ...
 [s2_norm_z s2_norm]=InterpS2IQ_Run04(current_data_set_time, dataset_times, s2_norm_z_iqs, s2_norm_iqs, noflow_times);
...
%       end
   ...
   [index iq_time_zDep] = NearestIQ_Run04(current_data_set_time,dataset_times,noflow_times);
...
%           fprintf('Its allowed %d  - %s \n',lug_iqs_xml.iq(i).global.gs_number,lug_iqs_xml.iq(i).global.filename_prefix);
 ...
 %      end
   ...
   [index iq_time_s2xyDep] = NearestIQ_Run04(current_data_set_time,dataset_times,noflow_times);
...
%       if ismember(lug_iqs_xml.iq(i).global.gs_number,allowed_gs)==1;
 ...
 %      end
   ...
   [index iq_time]  = NearestIQ_Run04(current_data_set_time,dataset_times,noflow_times);
...
%       end
   ...
   [index iq_time_s1xyzDep] = NearestIQ_Run04(current_data_set_time,dataset_times,noflow_times);
...
%       end
   ...
   [index iq_time_det_center] = NearestIQ_Run04(current_data_set_time,dataset_times,noflow_times);
