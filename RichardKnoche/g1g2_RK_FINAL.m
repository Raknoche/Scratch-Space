...
load('C:\Program Files\MATLAB\R2012a\bin\G1G2_Data\Run03Kr_170Vcm_SatCorr_SECenter.mat'); %Load Patched Kr Data
    ...
    s2_phe_bottom_xyz_kr170_phe=s2_phe_both_xyz_VUV_SatFixed(inrange(drift_time,[30 300]) & inrange(radius,[0 18]) & inrange(s2_phe_both_xyz_VUV_SatFixed,[1585,20000]) & inrange(s1_phe_both_xyz_VUV,[150,400]));
     ...
     Kr_170_SE=mean(SE_Size_VUV);
       ...
       %% Kr83m at 42.6 keV and 100 V/cm  -- NEEDS ITS OWN XYZ Corrections (LOAD DATA GIVES NO XYZ CORRECTION)
         clear radius s2x_c s2y_c drift_time s1_phe_both_xyz s2_phe_bottom_xyz S2_numelectrons_VUV
load('C:\Program Files\MATLAB\R2012a\bin\G1G2_Data\Run03Kr_100Vcm_SatCorr_SECenter.mat'); %Load Patched Kr Data
...
%%%%%%
     ...
     s2_phe_both_xyz_kr100=S2_numelectrons_VUV(inrange(drift_time,[30 300]) & inrange(radius_c,[0 18]) & s2_phe_both_xyz_VUV_SatFixed > 1585);
          ...
          clear Fit_kr_E cut_kr_sig_E Fit_kr_E Fit_kr_s1 Fit_kr_s2 cut_kr_sig_s1 cut_kr_sig_s2   
     Fit_kr_s1=fit([0:1:600]',hist(s1_phe_both_xyz_kr100,[0:1:600])','gauss1');
     Fit_kr_s2=fit([0:2:1000]',hist(s2_phe_both_xyz_kr100,[0:2:1000])','gauss1');  
     Fit_kr_s1_sig = Fit_kr_s1.c1/sqrt(2);
     Fit_kr_s2_sig = Fit_kr_s2.c1/sqrt(2);
...
load('C:\Program Files\MATLAB\R2012a\bin\G1G2_Data\Run03Kr_50Vcm_SatCorr_SECenter_TimeCut.mat'); %Load Patched Kr Data
...
%%%%%%
     ...
     s2_phe_bottom_xyz_kr50=S2_numelectrons_VUV(inrange(drift_time,[30 400]) & inrange(radius,[0 18]) & s2_phe_both_xyz_VUV_SatFixed > 1585);
    
     
     
          clear Fit_kr_E cut_kr_sig_E Fit_kr_E Fit_kr_s1 Fit_kr_s2 cut_kr_sig_s1 cut_kr_sig_s2   
     Fit_kr_s1=fit([0:1:600]',hist(s1_phe_both_xyz_kr50,[0:1:600])','gauss1');
     Fit_kr_s2=fit([0:2:1000]',hist(s2_phe_bottom_xyz_kr50,[0:2:1000])','gauss1');  
     Fit_kr_s1_sig = Fit_kr_s1.c1/sqrt(2);
     Fit_kr_s2_sig = Fit_kr_s2.c1/sqrt(2);
     ...
     clear radius s2x_c s2y_c drift_time s1_phe_both_xyz s2_phe_bottom_xyz S2_numelectrons_VUV   
load('C:\Program Files\MATLAB\R2012a\bin\G1G2_Data\Run03_Cs_final_SatCorr_SECenter.mat'); %Load Patched Kr Data
...
n_sig=2;
     ...
     s1_phe_both_cut_cs=s1_phe_both_xyz_cs( ((log10(s1_phe_both_xyz_cs)+1.*log10(s2_phe_both_xyz_cs)) < 9.05) & ((log10(s1_phe_both_xyz_cs)+1.*log10(s2_phe_both_xyz_cs)) > 8.87));
     s2_phe_both_cut_cs=s2_phe_both_xyz_cs_e( ((log10(s1_phe_both_xyz_cs)+1.*log10(s2_phe_both_xyz_cs)) < 9.05) & ((log10(s1_phe_both_xyz_cs)+1.*log10(s2_phe_both_xyz_cs)) > 8.87));

     s2_phe_both_cut_cs_bot=s2_phe_both_xyz_cs_e_bot( ((log10(s1_phe_both_xyz_cs)+1.*log10(s2_phe_both_xyz_cs)) < 9.05) & ((log10(s1_phe_both_xyz_cs)+1.*log10(s2_phe_both_xyz_cs)) > 8.87));
...
%      Cs_extra_err=abs(Cs_S2Mu-Cs_S2Mu_bot);
            ...
            %% Xe Activation Lines
         clear radius s2x_c s2y_c drift_time s1_phe_both_xyz s2_phe_bottom_xyz S2_numelectrons_VUV
load('C:\Program Files\MATLAB\R2012a\bin\G1G2_Data\Run03_XeAct_SatCorr_SECenter.mat'); %Load Patched Kr Data
...
n_sig=3;
     ...
     s2_phe_bottom_xyz_act_e=S2_numelectrons_VUV_SatFixed(inrange(drift_time,[30 300]) & inrange(radius,[0 18]));
...
%   
     ...
     Fit_kr_s1=fit([500:5:1500]',hist(s1_phe_both_131,[500:5:1500])','gauss1');
     Fit_kr_s2=fit([500:30:4000]',hist(s2_phe_bottom_131,[500:30:4000])','gauss1');    
     Fit_kr_s1_sig = Fit_kr_s1.c1/sqrt(2);
     Fit_kr_s2_sig = Fit_kr_s2.c1/sqrt(2);
     Fit_kr_s1_meanerr = Fit_kr_s1_sig/sqrt(length(s1_phe_both_131)); % == sigma/sqrt(N);
     Fit_kr_s2_meanerr = Fit_kr_s2_sig/sqrt(length(s2_phe_bottom_131)); % == sigma/sqrt(N);   
     %cut and fit around 3 sigma of the mean, after the first guess 
     ...
     Fit_kr_s1=fit([600:10:1800]',hist(s1_phe_both_127,[600:10:1800])','gauss1');
     Fit_kr_s2=fit([500:40:5500]',hist(s2_phe_bottom_127,[500:40:5500])','gauss1');     
     Fit_kr_s1_sig = Fit_kr_s1.c1/sqrt(2);
     Fit_kr_s2_sig = Fit_kr_s2.c1/sqrt(2);
     Fit_kr_s1_meanerr = Fit_kr_s1_sig/sqrt(length(s1_phe_both_127)); % == sigma/sqrt(N);
     Fit_kr_s2_meanerr = Fit_kr_s2_sig/sqrt(length(s2_phe_bottom_127)); % == sigma/sqrt(N);    
     %cut and fit around 3 sigma of the mean, after the first guess 
     ...
     Fit_kr_s1=fit([600:10:2000]',hist(s1_phe_both_129,[600:10:2000])','gauss1');
     Fit_kr_s2=fit([500:30:6000]',hist(s2_phe_bottom_129,[500:30:6000])','gauss1');     
     Fit_kr_s1_sig = Fit_kr_s1.c1/sqrt(2);
     Fit_kr_s2_sig = Fit_kr_s2.c1/sqrt(2);
     Fit_kr_s1_meanerr = Fit_kr_s1_sig/sqrt(length(s1_phe_both_129)); % == sigma/sqrt(N);
     Fit_kr_s2_meanerr = Fit_kr_s2_sig/sqrt(length(s2_phe_bottom_129)); % == sigma/sqrt(N);     
     %cut and fit around 3 sigma of the mean, after the first guess 
     ...
     Fit_kr_s1=fit([600:20:3500]',hist(s1_phe_both_127_2,[600:20:3500])','gauss1');
     Fit_kr_s2=fit([1000:50:15000]',hist(s2_phe_bottom_127_2,[1000:50:15000])','gauss1');    
     Fit_kr_s1_sig = Fit_kr_s1.c1/sqrt(2);
     Fit_kr_s2_sig = Fit_kr_s2.c1/sqrt(2);
     Fit_kr_s1_meanerr = Fit_kr_s1_sig/sqrt(length(s1_phe_both_127_2)); % == sigma/sqrt(N);
     Fit_kr_s2_meanerr = Fit_kr_s2_sig/sqrt(length(s2_phe_bottom_127_2)); % == sigma/sqrt(N);
     %cut and fit around 3 sigma of the mean, after the first guess 
...
%      Bi-214 at 607 keV (shitty stats) DONE
     ...
     Fit_kr_s1=fit([0:50:5000]',hist(s1_phe_both_214,[0:50:5000])','gauss1');
     Fit_kr_s2=fit([0:200:20000]',hist(s2_phe_bottom_214,[0:200:20000])','gauss1');    
     Fit_kr_s1_sig = Fit_kr_s1.c1/sqrt(2);
     Fit_kr_s2_sig = Fit_kr_s2.c1/sqrt(2);
     Fit_kr_s1_meanerr = Fit_kr_s1_sig/sqrt(length(s1_phe_both_214)); % == sigma/sqrt(N);
     Fit_kr_s2_meanerr = Fit_kr_s2_sig/sqrt(length(s2_phe_bottom_214)); % == sigma/sqrt(N);
     %cut and fit around 3 sigma of the mean, after the first guess 
...
Tot_bot_diffs = [16.2959   24.5270    0.8642  629.6990   54.5295  106.4575 138.0665  124.6813  552.9506]; %S2 Total v S2 bot differences
     ...
     S1_mean_sig=[(Kr_170_s1_meanerr.^2 + 1.9851.^2).^(1/2) (Kr_100_s1_meanerr.^2 + (1.9851*Kr_100_S1Mu/Kr_170_S1Mu).^2).^(1/2) (Kr_50_s1_meanerr.^2 + (1.9851*Kr_50_S1Mu/Kr_170_S1Mu).^2).^(1/2) (Cs_s1_meanerr.^2 + (1.9851*Cs_S1Mu/Kr_170_S1Mu).^2).^(1/2)...
         (Xe131_s1_meanerr.^2 + (1.9851*Xe131_S1Mu/Kr_170_S1Mu).^2).^(1/2) (Xe129_s1_meanerr.^2 + (1.9851*Xe129_S1Mu/Kr_170_S1Mu).^2).^(1/2) (Xe127_s1_meanerr.^2 + (1.9851*Xe127_S1Mu/Kr_170_S1Mu).^2).^(1/2)...
          (Xe127_2_s1_meanerr + (1.9851*Xe127_2_S1Mu/Kr_170_S1Mu).^2).^(1/2) (Bi214_s1_meanerr + (1.9851*Bi214_S1Mu/Kr_170_S1Mu).^2).^(1/2)]; % 
     S2_mean_sig=[((Kr_170_S2Mu*0.01).^2 + Kr_170_s2_meanerr.^2 + Tot_bot_diffs(1).^2 + 9.7790.^2).^(1/2) ((Kr_100_S2Mu*0.01).^2 + Kr_100_s2_meanerr.^2 + Tot_bot_diffs(2).^2 + (9.7790*Kr_100_S2Mu/Kr_170_S2Mu).^2).^(1/2) ((Kr_50_S2Mu*0.01).^2 + Kr_50_s2_meanerr.^2 + Tot_bot_diffs(3).^2 + (9.7790*Kr_50_S2Mu/Kr_170_S2Mu).^2).^(1/2) ((Cs_S2Mu*0.01).^2 + (Cs_S2Mu*0.055).^2 + Cs_s2_meanerr.^2 + Tot_bot_diffs(4).^2 + (9.7790*Cs_S2Mu/Kr_170_S2Mu).^2).^(1/2)...
         ((Xe131_S2Mu*0.01).^2 + Xe131_s2_meanerr.^2 + Tot_bot_diffs(5).^2 + (9.7790*Xe131_S2Mu/Kr_170_S2Mu).^2).^(1/2) ((Xe129_S2Mu*0.01).^2 + Xe129_s2_meanerr.^2 + Tot_bot_diffs(6).^2 + (9.7790*Xe129_S2Mu/Kr_170_S2Mu).^2).^(1/2) ((Xe127_S2Mu*0.01).^2 + Xe127_s2_meanerr.^2 + Tot_bot_diffs(7).^2 + (9.7790*Xe127_S2Mu/Kr_170_S2Mu).^2).^(1/2)...
          ((Xe127_2_S2Mu*0.01).^2 + Xe127_2_s2_meanerr.^2 + Tot_bot_diffs(8).^2 + (9.7790*Xe127_2_S2Mu/Kr_170_S2Mu).^2).^(1/2) ((Bi214_S2Mu*0.01).^2 + Bi214_s2_meanerr.^2 + Tot_bot_diffs(9).^2+ (9.7790*Bi214_S2Mu/Kr_170_S2Mu).^2).^(1/2)]; %
     ...
     ssfun = @(theta,data) 0.5*sum(((data.ydata-theta(1)*data.xdata-theta(2)).^2)./(data.xdataerr.^2 + data.ydataerr.^2)); %setting up sum of squares function as (1/dof)*sum((observed - expected)^2/variance)
...
% save('G1G2Cov','cov_m_b','cov_g1_EE','cov_g1_g2','cov_g1_1g2');
